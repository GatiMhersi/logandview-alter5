...
import { useProductsStore } from "../../../store/productsStore"; // Importa el store
import { Order, SortBy } from "@/components/products/components/sortProducts/service/sortFetch";
